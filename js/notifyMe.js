...
(function(e) {
    e.fn.notifyMe = function() {
        ...
        // Alert messages
        var thvalid        = '<p class="notify-valid">Congrats! You are in our list.<br>We\'ll inform you as soon as we ship.</p>';
        var thproblem      = '<p class="notify-valid">Hmm. Something is wrong with your email address.<br>Please double-check and try again.</p>';
        var thoops         = '<p class="notify-valid">Oops. Looks like something went wrong.<br>Please try again later.</p>';
        var thfake         = '<p class="notify-valid">Hmm. Something is wrong with your email address.<br>Please double-check and try again.</p>';
        ...
        e(this).on("submit", function(t) {
            ...
            if (p.test(h)) {
                ...
                $('#submit-form').html('Submitting <i class="fa fa-spinner" aria-hidden="true"></i>'); // Message displayed in the submit button during the sending
                o.show();
                e.ajax({
                    type: "POST",
                    url: s,
